...
@Component({
  ...
  providers: [CashSalesService, MessageService],
  templateUrl: './cash-sales.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class CashSalesComponent {
  private readonly fb = inject(FormBuilder);
  private readonly service = inject(CashSalesService);
  ...
  generateReport(): void {
    ...
    const filename = `ventas-efectivo-${request.dateFrom}-${request.dateTo}.${extension}`;
